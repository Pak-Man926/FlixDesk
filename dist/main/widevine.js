...
class WidevineManager {
    ...
    discoverWidevine() {
        ...
        const candidatePaths = [
            ...
            // 2. Application user data directory
            {
    ...
    applySwitches(enableHwAccel = true, enableWayland = true) {
        ...
        if (enableHwAccel) {
            electron_1.app.commandLine.appendSwitch('enable-features', 'VaapiVideoDecoder,VaapiVideoDecodeLinuxGL,CanvasOopRasterization');
